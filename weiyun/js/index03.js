    ...
    console.log(getBrothersById(1234))
    ...
    create.click(function() {
        ...
        creatDiv.innerHTML = '<div  class="file-item">\
    ...
    <i class=""></i>\
        ...
        folders.appendChild(creatDiv)
        console.log(folders)
        var spanId = $('.bread-nav').find('span').attr('spanid'); //找到新建文件夹id所在父级;
        console.log(arr.length)
        arr.push({
            id: dateId,
            title: '新建文件夹' + i,
